...
export default function EditHotelPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (isLoading) {
    return <div className="p-8 text-center text-slate-500">Loading hotel details...</div>;
  }
  ...
  return (
    <div className="w-full mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm">Update the details or re-assign the manager for this hotel.</p>
      </div>
