...
export default function HotelsListPage() {
  ...
  useEffect(() => {
    const fetchHotels = async () => {
      ...
      try {
        const url = query
          ? `/hotels?search=${encodeURIComponent(query)}`
          : "/hotels";
          ...
          <div className="mb-10 space-y-6">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              <input
                ...
                className="w-full rounded-3xl border border-slate-200 bg-white px-5 py-4 text-sm text-slate-900 shadow-sm outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/10"
              />
            </div>
          </div>
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-600 line-clamp-2 leading-relaxed">
                      Experience world-class service at {hotel.name}, located at{" "}
                      {hotel.address}. Perfect for business and leisure.
                    </p>
